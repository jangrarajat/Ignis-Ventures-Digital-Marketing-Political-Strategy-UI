  ...
  const testimonials = [
    {
      ...
      text: 'Ignis Ventures transformed our school\'s online presence. Their creative team delivered outstanding results.',
      rating: 5,
    },
    {
      name: 'Priya Sharma',
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
            ...
            <div className="bg-gray-50 border border-gray-200 p-8 rounded-xl hover:shadow-lg transition-all duration-300 hover:-translate-y-1 animate-fade-in-up">
              ...
              <h3 className="text-2xl font-bold text-black mb-3">School Media Management</h3>
